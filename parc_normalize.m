...
if num_empty>0
    error('Error. There are %d empty time courses within the graymatter mask in sub%05d. You might delete this subject, or increase the delta value in XXX_eigen.m. \n',num_empty,cSub);
end
