function SLIC_mean_parc(iK,iPart,iRep)
...
% save to .mat file
time=toc/3600;
save(sprintf('SLIC_mean_parc/K%d_part%d_rep%d.mat',cK,iPart,iRep),'img_parc','K','time');
fprintf('Time to do parcellation: %0.2f hours. \n',time);

% save to .nii file
file_mask='graymatter.nii';
file_out=sprintf('SLIC_mean_parc/K%d_part%d_rep%d.nii',cK,iPart,iRep);
