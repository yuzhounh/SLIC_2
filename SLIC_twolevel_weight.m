function SLIC_twolevel_weight(iK,iPart,iRep)
% Construct the two-level weight matrix for SLIC.
% 2016-5-28 16:47:43
...
time=toc/3600;
save(sprintf('SLIC_twolevel_weight/K%d_part%d_rep%d.mat',cK,iPart,iRep),'W','nEmpty','time','-v7.3');
